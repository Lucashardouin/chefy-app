<template>
    <form @submit.prevent="submitInscription">
      <input v-model="newUser.restaurant_name" name="restaurant_name" placeholder="Nom du restaurant" />
      <input v-model="newUser.username" name="username" placeholder="Identifiant" />
      <input v-model="newUser.email" name="email" type="email" placeholder="Email" />
      <input v-model="newUser.mdp" name="password" type="password" placeholder="Mot de passe" />
      <input v-model="newUser.adresse" name="adresse" placeholder="Adresse" />
      <input v-model="newUser.ville" name="ville" placeholder="Ville" />
      <input v-model="newUser.code_postal" name="code_postal" placeholder="Code postal" />
      <input ref="imageInput" type="file" name="image" @change="handleImageChange" />
